...
<template>
  <div class="about-page team">
          ...
          <div>
            <div class="swiper members" ref="membersSwiper">
                <div class="swiper-wrapper">
                    <!-- <div class="swiper-slide">
                        <div class="curtain"></div>
                        <img class="image" src="http://itwizard.mn/filemanager/uploads/staff_uVkIe4uZ9PCwrIUOQF7F_1618568437.jpg" alt="">
                    </div> -->
    ...
    <div class="container office_wall_container">
      <img src="@/assets/image/content/office_wall.jpg" alt="" class="office__wall">
      <div class="curtain-blck"></div>
      <div class="text">
        <router-link to="/gallery">itwizard office</router-link>
      </div>
    </div>
  </div>
</template>
